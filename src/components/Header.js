...
const topics = ["Beach", "Wildlife", "Mountain View", "Motivational", "Flowers", "Foods"];
...
const Header = () => {
    ...
    return (
        <div className='header'>
            <div className='logo'><Link to='/home'><img className='logoMain' src={logo} /></Link></div>
            ...
            <div className='linkBox'>
                {
                    topics && topics.map((topic, index) => {
                        return (
                            <Link to={`/${topic.split(" ")[0].toLowerCase()}`} key={index}>
